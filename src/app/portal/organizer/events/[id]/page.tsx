...
export default function EventDashboard() {
  ...
  async function fetchData() {
    ...
    try {
      ...
      const analyticsRes = await fetch(`/api/organizer/CreatedEvents/${id}/analytics`)
  ...
  const notMarked = analytics.find(a => a.status === "NOT_MARKED")?.count || 0
    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div className="bg-slate-900 p-5 rounded-xl">
          ...
          <h2 className="text-2xl font-bold text-indigo-400">{attendanceRate}%</h2>
        </div>
